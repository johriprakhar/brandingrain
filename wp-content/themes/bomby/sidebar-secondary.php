...
?>
	<div class="col-md-3 sidebar" role="complementary">
		<div class="sidebar-inner">
			...
			<?php if ( is_active_sidebar( apply_filters('ivan_replace_sidebars', 'sidebar-secondary' ) ) ) : ?>
				<?php dynamic_sidebar( apply_filters('ivan_replace_sidebars', 'sidebar-secondary' ) ); ?>
			<?php else: ?>
