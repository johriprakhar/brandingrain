 ...
 */
require_once get_template_directory().'/theme-configs/tgm/class-tgm-plugin-activation.php';
...
function ivan_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'required' 	=> true,
			'version'	=> '3.5.5.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
		),
		...
		array(
			...
			'source'			 => get_stylesheet_directory() . '/theme-configs/plugins/js_composer.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),

		array(
			'name'				=> 'Elite Addons', // The plugin name.
			'slug'				=> 'elite-addons-vc', // The plugin slug (typically the folder name).
			'source'		    => get_stylesheet_directory() . '/theme-configs/plugins/elite-addons-vc.zip', // The plugin source.
			'required'			=> true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'		   => get_stylesheet_directory() . '/theme-configs/plugins/mega_main_menu.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),
		...
		array(
			...
			'source'		   => get_stylesheet_directory() . '/theme-configs/plugins/revslider.zip', // The plugin source.
			'required'		   => true, // If false, the plugin is only 'recommended' instead of required.
		),
