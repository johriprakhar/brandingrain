...
class Ivan_Layout_Header_Horizontal_With_Sidebar extends Ivan_Layout  {

	// Layout slug used as parameters to actions and filters
	public $slug = '_horizontal_with_sidebar';

	public function return_template_path() {
		return 'horizontal-with-sidebar';
	}
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'horizontal-with-sidebar') );
