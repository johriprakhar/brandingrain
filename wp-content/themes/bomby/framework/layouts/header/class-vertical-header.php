...
class Ivan_Layout_Vertical_Header extends Ivan_Layout  {

	// Layout slug used as parameters to actions and filters
	public $slug = '_vertical_header';
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'vertical-header') );
