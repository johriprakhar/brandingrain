...
class Ivan_Layout_Header_Classic_Right_Area_Dark extends Ivan_Layout {

	// Layout slug used as parameters to actions and filters
	public $slug = '_clasic_right_area_dark';

	public function return_template_path() {
		return 'classic-right-area-dark';
	}
	...
	public function display() {
		...
		get_template_part( 'framework/templates/header/part', apply_filters('ivan_header_get_template', 'classic-right-area-dark') );
