...
/**
 *
 * Template Part called at class Ivan_Layout_Header_Style2_Logo_Centered
 *
...
<div class="<?php echo apply_filters( 'iv_header_classes', 'iv-layout header classic-logo-centered style2-logo-centered hide-container '. $_classes ); ?>">
	<div class="container to-hide">
		<div class="row">

			<div class="col-md-4 hidden-xs hidden-sm calc-height-area iv-modules-to-left">
				<?php
