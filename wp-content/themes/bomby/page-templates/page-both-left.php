...
get_header(); ?>
	...
	<div class="<?php echo apply_filters( 'iv_content_wrapper_classes', 'iv-layout content-wrapper with-sidebar content-both-left-sidebar ' ); ?><?php echo esc_attr($_classes); ?>">
		<div class="container">
			...
			<?php endif; ?>
				...
				<div class="row">
					...
					<div class="col-md-6 site-main sidebar-enabled sidebar-left" role="main">
